...
export function DeleteConfirmation({ isOpen, onClose, partner, onConfirm, isLoading }: DeleteConfirmationProps) {
  if (!partner) return null

  return (
    <Modal isOpen={isOpen} title='Delete partner' onClose={onClose}>
             <div className='p-5'>
               <div>
                 <h2 className='text-xl font-bold mb-3'>Are you sure?</h2>
              <div>
                This will deactivate the entry for{" "}
